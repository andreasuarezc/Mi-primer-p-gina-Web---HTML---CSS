...
<body>
    <main class="main">
        <div class="contactanos2">
            <h1 class="titulo-section">¿Desea editar este anuncio?</h1>
            ...
            while ($row = mysqli_fetch_assoc($resultado)){
                ...
                <form class="form" action="editar2.php" method="POST">
                    <input type="hidden" name="id_registro" value = "<?php echo $id_registro ?>">
                    <div class="form-label">
                        <label>Titulo</label>
                        <input type="text" class="form-input" name="titulo" value = "<?php echo $titulo ?>">
                    </div>
                    <div class="form-label">
                        <label for="inputlink_imagen">Link Imagen</label>
                        <input type="text" class="form-input" id="inputlink_imagen" name="link_imagen" value = "<?php echo $link_imagen ?>">
                    </div>
                    <div class="form-label">
                        <label for="inputdescripcion">Descripción</label>
                        <br>
                        <textarea rows="6" cols="30" class="form-textarea" name="descripcion"><?php echo $descripcion ?></textarea>
                    </div>
                    <button type="submit" class="form-submit">Actualizar</button>
                </form>
                <?php 
            } ?>
        </div>
